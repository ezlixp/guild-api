...
public enum Prepend {
    ...
    GUILD(Text.literal("󏿼󏿿󏿾")
            .append(" ").setStyle(TextUtils.fontOf(Identifier.of("chat/prefix")).withColor(Formatting.AQUA)), Text.literal("\uDAFF\uDFFC\uE001\uDB00\uDC06")
            .append(" ").setStyle(TextUtils.fontOf(Identifier.of("chat/prefix")).withColor(Formatting.AQUA)));
