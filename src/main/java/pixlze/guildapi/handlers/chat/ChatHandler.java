...
//            requestBody.add("users", GuildApi.gson.fromJson(Arrays.toString(new String[]{raidMatcher.group(1),
//            raidMatcher.group(2), raidMatcher.group(3), raidMatcher.group(4)}), JsonElement.class));
//            requestBody.add("raid", GuildApi.gson.fromJson(raidMatcher.group(5), JsonElement.class));
//            requestBody.add("timestamp", GuildApi.gson.fromJson(String.valueOf(Instant.now().toEpochMilli()),
//            JsonElement.class));
